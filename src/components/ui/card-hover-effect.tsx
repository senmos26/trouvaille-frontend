...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl h-full w-full p-4 overflow-hidden bg-card border border-border dark:border-white/[0.2] group-hover:border-[#FFD700]/50 relative z-20 transition-colors",
        className
      )}
    >
